...
* [Methods](#methods)
* [Callbacks](#callbacks)
* [Grid AdminController](#grid-controller)
...
Read more about controller interface in [Grid AdminController](#grid-controller) section.
...
When grid data is loaded by pages (`pageLoading` is `true`) sorting calls `controller.loadData` with sorting parameters. Read more in [Grid AdminController](#grid-controller) section.
