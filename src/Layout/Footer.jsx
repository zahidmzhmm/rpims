        ...
        <div className="bg-ash w-full py-4 px-2 lg:px-9">
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4 justify-center mt-6">
                ...
                <div>
                    ...
                    <ul>
                        <li className="mb-2"><Link to={``} className="text-white">Search Mentors</Link></li>
                        <li className="mb-2"><Link to={``} className="text-white">Login</Link></li>
                        <li className="mb-2"><Link to={``} className="text-white">Register</Link></li>
                        <li className="mb-2"><Link to={``} className="text-white">Booking</Link></li>
                        <li className="mb-2"><Link to={``} className="text-white">Dashboard</Link></li>
                    </ul>
                </div>
                <div>
                    <h1 className="font-bold text-xl text-second mb-3">For Mentor</h1>
                    <ul>
                        <li className="mb-2"><Link to={``} className="text-white">Apoinment</Link></li>
                        <li className="mb-2"><Link to={``} className="text-white">Login</Link></li>
                        <li className="mb-2"><Link to={``} className="text-white">Register</Link></li>
                        <li className="mb-2"><Link to={``} className="text-white">Chat</Link></li>
                        <li className="mb-2"><Link to={``} className="text-white">Dashboard</Link></li>
                    </ul>
                </div>
                <div>
